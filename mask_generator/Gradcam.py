...
mask_dir = '/home/seulgi/work/nn-uncertainty/mask_generator/6000masks'
output_dir = '/home/seulgi/work/nn-uncertainty/evaluation/0222-result' # for visualization
csv_output_dir = '/home/seulgi/work/nn-uncertainty/evaluation/0222-csv'
...
def process_batch(data_loader, model, explainer, explanations, batch_number, start_index):
    ...
    for i, (img, data_classes) in enumerate(data_loader, start=start_index):
        ...
        plt.savefig(output_dir+"/6000variance_{:04d}.png".format(i+17))
        ...
        plt.savefig(output_dir+"/6000originalexplainability_{:04d}.png".format(i+17))
        plt.close()
        ...
        np.save(mask_dir+'/6000uncertain_{:05}.npy'.format(i), variance)
    ...
    batch_results_true.to_csv(f'{csv_output_dir}/6000true_{batch_number}.csv', index=False)
    batch_results_false.to_csv(f'{csv_output_dir}/6000false_{batch_number}.csv', index=False)
...
maskspath = 'masks.npy'
uncertain_maskpath = '/home/seulgi/work/nn-uncertainty/mask_generator/100masks/uncertainmask.npy'
