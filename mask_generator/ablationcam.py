...
mask_dir = '/home/seulgi/work/data/ablationcammasks'
output_dir = '/home/seulgi/work/data/ablationcam-result' # for visualization
csv_output_dir = '/home/seulgi/work/data/ablationcam-csv'
...
explainer = AblationCAM(model, target_layers=target_layers)
uncertain = RISE(model, args.input_size, args.gpu_batch)
targets=[ClassifierOutputTarget(295)]
# Generate masks for RISE or use the saved ones.
maskspath = 'masks.npy'
uncertain_maskpath = '/home/seulgi/work/data/ablationcammasks/uncertainmask.npy'
...
if (EXPLAIN_FOR_THE_FIRST_TIME == 1):
    ...
    np.save(explanation_dir+'/ablationcam-exp_{:05}-{:05}.npy'.format(args.range[0], args.range[-1]), explanations)
else:
    explanations_filename = explanation_dir+'/ablationcam-exp_{:05}-{:05}.npy'.format(args.range[0], args.range[-1])
