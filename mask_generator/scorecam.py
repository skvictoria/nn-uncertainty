...
mask_dir = '/home/seulgi/work/data/scorecammasks'
output_dir = '/home/seulgi/work/data/scorecam-result' # for visualization
csv_output_dir = '/home/seulgi/work/data/scorecam-csv'
...
explainer = ScoreCAM(model, target_layers=target_layers)
uncertain = RISE(model, args.input_size, args.gpu_batch)
targets=[ClassifierOutputTarget(295)]
# Generate masks for RISE or use the saved ones.
maskspath = 'masks.npy'
uncertain_maskpath = '/home/seulgi/work/data/scorecammasks/uncertainmask.npy'
...
if (EXPLAIN_FOR_THE_FIRST_TIME == 1):
    ...
    np.save(explanation_dir+'/scorecam-exp_{:05}-{:05}.npy'.format(args.range[0], args.range[-1]), explanations)
else:
    explanations_filename = explanation_dir+'/scorecam-exp_{:05}-{:05}.npy'.format(args.range[0], args.range[-1])
